  ...
  public void printView() throws IOException {
    ...
    for (IAnimShape shape : shapes) {
      if (shape.getShapeType().equals("rectangle")) {
        ...
        if (looping) {
          output.append(String.format("\n<animate attributeType=\"xml\" begin=\"base.begin\" " +
                          "dur=\"1ms\" " + "attributeName=\"x\" to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"y\" " + "to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"width\" " + "to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"height\" " + "to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"fill\" " + "to=\"rgb(%f%%,%f%%,%f%%)\" " +
                          "fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
      ...
      if (shape.getShapeType().equals("oval")) {
        ...
        if (looping) {
          output.append(String.format("\n<animate attributeType=\"xml\" begin=\"base.begin\" " +
                          "dur=\"1ms\" " + "attributeName=\"cx\" to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"cy\" " + "to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"rx\" " + "to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"ry\" " + "to=\"%f\" fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
                          "attributeName=\"fill\" " + "to=\"rgb(%f%%,%f%%,%f%%)\" " +
                          "fill=\"freeze\" />" +
                          "\n<animate attributeType=\"xml\" begin=\"base.begin\" dur=\"1ms\" " +
